...
#include <dsms/include/execution/indexes/hash_index.h>
...
#define BUCKET(n,i) (&(*((HashIndex::Entry **)(n) + i)))
...
#define DATA_PART(p) ((HashIndex::Entry*)((p) + dataPartOffset))
...
int HashIndex::getIntProperty (int property, int& val)
{
	...
	Monitor::PropertyMonitor propertyMonitor;
